...
<section class="section dashboard">
    <div class="container mt-5">
        ...
        <a href="{{ route('superadmin.artikel.create') }}" class="btn btn-primary floating-add-btn">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                <a href="{{ route('superadmin.artikel.show', $article->id) }}">{{ Str::limit($article->judul, 50) }}</a>
                            </h5>
                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="{{ route('superadmin.artikel.edit', $article->id) }}" class="btn btn-outline-primary btn-sm me-2">
